...
```
git remote set-url origin https://github.com/cp16net/countbeat
...
```
mkdir -p ${GOPATH}/github.com/cp16net
cd ${GOPATH}/github.com/cp16net
git clone https://github.com/cp16net/countbeat
```
